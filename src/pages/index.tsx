...
const VideoBg = () => {
  ...
  return (
    <>
      <SEO title="GameStand" description="The NEXUS App simplifies your access to your games, unifying all platforms into one." />
      <Background config="flex flex-col">
        <LandingHeader topPage={topPage} handleClick={handleClick} handleRegister={handleRegister} handleLogin={handleLogin} />
        <SupportedPlatforms handleClick={handleClick} midPage={midPage} />
        {/* <Creators handleClick={handleClick} bottomPage={bottomPage} /> */}
      </Background>
    </>
  );
};
