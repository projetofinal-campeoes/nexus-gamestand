...
export default function GameCard({ name, img, platform, type }: GameCard) {
  ...
  return (
    <li
      className={
        type === "large"
          ? "w-[100%] h-[281px] bg-boxcolor rounded-lg overflow-hidden relative"
          : styles.listItem
      }
    >
        ...
        <div className={styles.content}>
          <div>
            <Image
              ...
              quality={100}
              placeholder="blur"
              blurDataURL="https://cdn6.aptoide.com/imgs/1/3/5/135414bbfd2c62340daf0f53516fc106_screen.jpg?h=500"
            />
          </div>
